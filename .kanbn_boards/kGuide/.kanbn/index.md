...
- [desktop-js-get-permissions-fallback-check](tasks/desktop-js-get-permissions-fallback-check.md)
- [guide-creation-elements-get-doubled](tasks/guide-creation-elements-get-doubled.md)
- [seperate-licensing](tasks/seperate-licensing.md)
- [display-start-k-guide-even-if-no-guides](tasks/display-start-k-guide-even-if-no-guides.md)
